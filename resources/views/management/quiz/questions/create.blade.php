                                                ...
                                                <div class="row wow-remove">
                                                    <div class="col-4">
                                                        <div class="main_container my-3">
                                                            <div class="form-check form-check-radio">
                                                                <label>
                                                                    <input  name="correct_option[0]" type="radio" checked class="status custom-checkbox" value="1">
                                                                    <span>Correct (a)</span>
                                                                </label>
                                                            </div>
                                                            <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                                ...
                                                                <input type="file" name="option_image[]" accept=".jpg,.gif,.png,.webp"
                                                                       class="main_file w-100 h-100 form-control position-absolute  opacity-0" />
                                                                <div class="img-thumb">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-4">
                                                        <div class="main_container my-3">
                                                            <div class="form-check form-check-radio">
                                                                <label>
                                                                    <input name="correct_option[1]" type="radio" class="status custom-checkbox" value="1">
                                                                    <span>Correct (b)</span>
                                                                </label>
                                                            </div>
                                                            <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="main_container my-3">
                                                            <div class="form-check form-check-radio">
                                                                <label>
                                                                    <input  name="correct_option[2]" type="radio" class="status custom-checkbox" value="1">
                                                                    <span>Correct (c)</span>
                                                                </label>
                                                            </div>
                                                            <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="main_container my-3">
                                                            <div class="form-check form-check-radio">
                                                                <label>
                                                                    <input  name="correct_option[3]" type="radio" class="status custom-checkbox" value="1">
                                                                    <span>Correct (d)</span>
                                                                </label>
                                                            </div>
                                                            <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="main_container my-3">
                                                            <div class="form-check form-check-radio">
                                                                <label>
                                                                    <input  name="correct_option[4]" type="radio" class="status custom-checkbox" value="1">
                                                                    <span>Correct (e)</span>
                                                                </label>
                                                            </div>
                                                            <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="main_container my-3">
                                                            <div class="form-check form-check-radio">
                                                                <label>
                                                                    <input  name="correct_option[5]" type="radio" class="status custom-checkbox" value="1">
                                                                    <span>Correct (f)</span>
                                                                </label>
                                                            </div>
                                                            <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                    ...
                                    <div class="row my-1">
                                        ...
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="category" id="Quiz-type" data-placeholder="Select">
                                                <option {{ old('category') == 'Sequence' ? 'Selected' : '' }}  value='Sequence'>Sequence</option>
                                                <option {{ old('category') == 'Vision' ? 'Selected' : '' }}  value='Vision'>Vision</option>
                                                <option {{ old('category') == 'Numeric' ? 'Selected' : '' }}  value='Numeric'>Numeric</option>
