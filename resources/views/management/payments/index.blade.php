                        ...
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                @foreach($payments as $row)
                                    <tr>
                                        <td>
                                            <a class="text-primary text-decoration-none" href="{{route('order.show',$row->id)}}">
                                                <small>
                                                    {{$row->user->name}}
                                                    <br>
                                                    {{$row->user->email}}
                                            ...
                                            <td><label class="badge badge-info text-uppercase" data-toggle="modal" data-target="#active_inactive">{{$row->status}}</label>
